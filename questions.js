...
var questions = [
    ...
    },
    {
        ...
        choices: ["clearInterval", "clearTimer", "intervalOver", "none"],
        answer: "clearTimer"
    },
    {
    ...
    },
    {
        ...
        choices: ["acts as breakpoint in program", "debugs error in current statement", "debugs all erros in program", "all"],
        answer: "acts as breakpoint in program"
    },
    {
        title: "How can a datatype be declared to be a constant type?",
        choices: ["constant", "let", "var", "const"],
        answer: "const"
    }
]
